<%@ Page Title="用户授权" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="UI_Security_add" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <ul class="queryarea">
                <li style="width: 100%">
                    <asp:Button ID="updateUser" runat="server" Text="新  增" OnClick="updateUser_Click" Style="margin-left: 40%;" Width="100px" />
                </li>
                <li style="width: 100%">

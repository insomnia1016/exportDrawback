<%@ Page Title="定金表单列表" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="DepositList.aspx.cs" Inherits="UI_payment_DepositList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <ul class="queryarea">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
            ...
            DataKeyNames="deposit_id,amount_all,agenter,agent_date,check_status,pay_amount_for,unpay_amount_for,check_amount_for,currencyID" >
            <Columns>
                ...
                <asp:BoundField DataField="pay_amount_for" DataFormatString="{0:N2}" HeaderText="已支付金额" />
                <asp:BoundField DataField="unpay_amount_for" DataFormatString="{0:N2}" HeaderText="未支付金额" />
                <asp:BoundField DataField="check_amount_for" DataFormatString="{0:N2}" HeaderText="本次支付" />

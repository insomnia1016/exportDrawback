<%@ Page Title="付款类型维护" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="typeManager.aspx.cs" Inherits="UI_payment_typeManager" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="name" HeaderText="收款类型" />
        </Columns>
    </asp:GridView>
</asp:Content>

...
public partial class UI_payment_POOrderList : System.Web.UI.Page
{
    ...
    private void GridViewBind(int id, int currencyID,string custName)
    {
        ...
        DataSet ds1 = da.getUnCheckPOOrderList(id, currencyID);
    ...
    {
        //FBillNo,FDate,FAmount,FCurrencyID,FSettleDate
        ds = new DataSet();
        ...
        ds.Tables.Add(dt);
        Session[UserInfoAdapter.CurrentUser.Name + "POOrder"] = ds;

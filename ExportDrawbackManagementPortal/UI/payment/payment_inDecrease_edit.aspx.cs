...
public partial class UI_payment_payment_inDecrease_edit : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        T_PaymentIndecreaseList list = new T_PaymentIndecreaseList();
    ...
    {
        int index = GridView1.SelectedIndex;
        string str_bill_no = (GridView1.SelectedRow.Cells[1].Controls[0] as HyperLink).Text;
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            try
            {
                bool result = pa.depositIsUsed(bill_no);
                if (result)
                {

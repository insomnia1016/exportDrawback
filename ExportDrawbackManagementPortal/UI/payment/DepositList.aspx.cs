...
public partial class UI_payment_DepositList : System.Web.UI.Page
{
    ...
    protected void btn_import_Click(object sender, EventArgs e)
    {
        ...
        dt.Columns.Add("pay_amount_for", typeof(Decimal));
        dt.Columns.Add("unpay_amount_for", typeof(Decimal));
        ...
        foreach (string id in (List<string>)this.SelectedItems)
        {
            ...
            dr["pay_amount_for"] = Decimal.Parse(item[5].Trim()==""?"0":item[5].Trim());
            dr["unpay_amount_for"] = Decimal.Parse(item[6].Trim() == "" ? "0" : item[6].Trim());
        ...
        ds.Tables.Add(dt);
        Session[UserInfoAdapter.CurrentUser.Name + "PayDepos"] = ds;

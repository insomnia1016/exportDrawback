<%@ Page Title="添加增减单" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="payment_inDecrease_add.aspx.cs" Inherits="UI_payment_payment_inDecrease_add" %>
    ...
    <ul class="queryarea">
        <li><span class="title">供应商：</span>
            <span class="control">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" SetFocusOnError="true" runat="server" ControlToValidate="customer" ErrorMessage="供应商不能为空"></asp:RequiredFieldValidator>

<%@ Page Title="利润核算审核" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="ProfitAccountingAudit.aspx.cs" Inherits="UI_Profit_ProfitAccountingAudit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <ul class="queryarea">
            ...
            <li style="width: 30%"><span class="title">部门</span>
            <span class="control">
                <asp:TextBox ID="txt_dept_id" Enabled="false" runat="server"></asp:TextBox>
            </span>
        </li>
        <li style="width: 30%"><span class="title">业务员</span>
            <span class="control">

<%@ Page Title="个人未收款销售列表" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="receiptList.aspx.cs" Inherits="UI_QueryAndReports_receiptList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <ul class="queryarea">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
            ...
            DataKeyNames="FInterID,FBillNo,FDate,FInvoiceAmountFor,FReceiveAmountFor,FUnReceiveAmountFor,FCurrencyID,FNote" >
            <Columns>
                ...
                <asp:BoundField DataField="FBillNo" HeaderText="销售发票号" />
                <asp:BoundField DataField="FDate" DataFormatString="{0:d}" HeaderText="单据日期" />                                                                 
                <asp:BoundField DataField="FInvoiceAmountFor" DataFormatString="{0:N2}" HeaderText="订单金额" />
                <asp:BoundField DataField="FReceiveAmountFor" DataFormatString="{0:N2}" HeaderText="已核销金额" />
                <asp:BoundField DataField="FUnReceiveAmountFor" DataFormatString="{0:N2}" HeaderText="未核销金额" />

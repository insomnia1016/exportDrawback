<%@ Page Title="增减费用单修改" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="InDecreaseEdit.aspx.cs" Inherits="UI_QueryAndReports_InDecreaseEdit" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" PageSize="15"
       ...
       >
        <Columns>
            ...
            <asp:HyperLinkField DataTextField="bill_no" HeaderText="单据编码" Target="_blank" DataNavigateUrlFields="bill_no" DataNavigateUrlFormatString="InDecreaseDetail.aspx?id={0}" />

        ...
        <asp:GridView ID="GridView1" runat="server" ShowFooter="true" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20">
            <Columns>
                ...
                <asp:TemplateField HeaderText="配件名称">
                    <ItemTemplate>
                        <asp:TextBox ID="txt_accessory" runat="server" Style="text-align: center"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="配件价格">
                    <ItemTemplate>
                        <asp:TextBox ID="txt_accessory_price" runat="server" AutoPostBack="true" OnTextChanged="txt_accessory_price_TextChanged" onKeyPress="if (event.keyCode!=46 && (event.keyCode<48 || event.keyCode>57)) event.returnValue=false" Style="text-align: center"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="利润（元）">
                    ...
                    <FooterTemplate>
                        <asp:Label ID="lbl_profit_all" runat="server" Text="总计："></asp:Label>
                    </FooterTemplate>
                </asp:TemplateField>

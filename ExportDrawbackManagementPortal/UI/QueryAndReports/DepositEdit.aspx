<%@ Page Title="定金单修改" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="DepositEdit.aspx.cs" Inherits="UI_QueryAndReports_DepositEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h2 style="float: left; text-align: left; width: 100%;">修改定金表体数据</h2>

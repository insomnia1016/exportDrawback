<%@ Page Title="收款单审核列表" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="receipt_audit.aspx.cs" Inherits="UI_QueryAndReports_receipt_audit" %>

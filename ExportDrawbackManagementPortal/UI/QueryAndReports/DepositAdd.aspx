<%@ Page Title="定金收取" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="DepositAdd.aspx.cs" Inherits="UI_QueryAndReports_DepositAdd" %>
...
<%@ Reference Page="~/UI/QueryAndReports/SEOrderList.aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
        function PopupDepositWindow() {
            ...
            window.open("SEOrderList.aspx?custName=" + customer + "&id=" + id, "", "status=no,resizable=no,toolbar=no,menubar=no,location=no,scroll=no");
        }
    </script>

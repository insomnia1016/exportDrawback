<%@ Page Title="发票明细查询" Language="C#" MasterPageFile="~/UI/MasterPage/DetailPage.master" AutoEventWireup="true" CodeFile="ICSaleList.aspx.cs" Inherits="UI_QueryAndReports_ICSaleList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" ShowFooter="true" AllowPaging="True" AllowSorting="True" PageSize="20"
        ...
        <Columns>
            <asp:HyperLinkField DataTextField="receipt_id" HeaderText="收款票号" Target="_blank" DataNavigateUrlFields="receipt_id" DataNavigateUrlFormatString="receipt_detail.aspx?id={0}" />
            <asp:BoundField DataField="FBillNo" HeaderText="销售发票号" />
            <asp:BoundField DataField="FDate" DataFormatString="{0:d}" HeaderText="单据日期" />
            <asp:BoundField DataField="FName" HeaderText="客户" />
            <asp:BoundField DataField="FAmountFor" DataFormatString="{0:N}" HeaderText="发票金额" />

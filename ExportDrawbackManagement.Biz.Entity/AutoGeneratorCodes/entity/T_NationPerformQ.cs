// Auto generated by MappingTools at 2009-11-06 09:48:39
...
namespace PLM.Biz.Entity
{
        ...
        /// 全国水平季度数据
        /// </summary>
	public partial class T_NationPerformQ
	{
...
public static class NameDefine
        ...
        /// 默认表名
        /// </summary>
public const string DefaultTableName = "NATION_PERFORM_Q";
        /// <summary>
        /// 属性名称定义 第一（法定）数量
        /// </summary>
...
public const string FieldNameTrafMode = "TRAF_MODE";
        /// <summary>
        /// 属性名称定义 周期标识（PIC YYYYQ），其中Q为1、2、3、4
        /// </summary>
public const string PropertyNamePeriodId = "PeriodId";
        /// <summary>
        /// 字段名称定义 周期标识（PIC YYYYQ），其中Q为1、2、3、4
        /// </summary>

...
{
    public class NationPerformYManager : BaseManager<T_NationPerformY>, INationPerformYManager
    {
        #region INationPerformYManager 成员

        public DataTable GetData(Q_NationPerformY para)
        {
            //获得本年度统计数据
            /*

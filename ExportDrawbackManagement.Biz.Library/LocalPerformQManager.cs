...
{
    public class LocalPerformQManager : BaseManager<T_LocalPerformQ>, ILocalPerformQManager
    {
        #region ILocalPerformQManager 成员
        ...
        /// <returns></returns>
        public DataTable F004(Q_LocalPerformQ para)
        {
            #region 变量定义
            ...
            const string nationTableName = T_NationPerformQ.NameDefine.DefaultTableName;
        ...
        public DataTable F005(Q_LocalPerformQ para, FilterBy filterby)
        {

...
{
    public class NationPerformMManager : BaseManager<T_NationPerformM>, INationPerformMManager
    {
        #region INationPerformMManager 成员

        public DataTable GetData(Q_NationPerformM para)
        {
            //获得本年度统计数据
            /*

...
{
    class PaymentDepositManager : BaseManager<T_PaymentDepositHead>, IPaymentDepositManager
    {
        public string getLastDepositID(string key)
        {
            Database db = Dao.GetDatabase();
            string lastBillNo = string.Empty;
            string sql = @"SELECT * FROM [dbo].[payment_deposit_head] where  deposit_id like @deposit_id order by deposit_id desc";
        ...
        public DataSet getDoneDepositID(string customer_name)
        {
            Database db = Dao.GetDatabase();
            DataSet ds;
            string sql = @"SELECT * FROM [dbo].[POOrderNODone] where customer_name=@customer_name";
            using (DbConnection cn = db.CreateConnection())
            {
                DbCommand cmd = db.GetSqlStringCommand(sql);
        ...
        public DataSet getUnCheckPOOrderList(int FSupplyID, int currencyID)
        {
            Database db = Dao.GetDatabase("KingDeeConnection");
            DataSet ds;
            string sql = @"SELECT  MIN(a.FBillNo) AS FBillNo ,
                                    MIN(a.FDate) AS FDate ,
                                    SUM(b.FAllAmount) AS FAmount ,
                                    MIN(a.FCurrencyID) AS FCurrencyID ,
                                    MIN(a.FSettleDate) AS FSettleDate 
                            FROM    dbo.POOrder a ,
                                    dbo.POOrderEntry b
                            WHERE   a.FBrNo = b.FBrNO
                                    AND a.FInterID = b.FInterID
                                    AND a.FCancellation = 0 
                                    --AND a.FSupplyID=@FSupplyID 
        ...
        public void addDepositHead(T_PaymentDepositHead head)
        {
            ...
            Database db = Dao.GetDatabase();
            string sql = @"INSERT INTO [dbo].[payment_deposit_head]
                                   ([deposit_id]
                                   ,[itemID]
                                   ,[customerID]
                                   ,[customer]
            ...
            try
            {
                using (DbConnection cn = db.CreateConnection())
                {
                    ...
                    db.AddInParameter(cmd, "@unpay_amount_for", DbType.Decimal, head.UnpayAmountFor);
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"INSERT INTO [dbo].[payment_deposit_list]
                                   ([deposit_id]
                                   ,[g_no]
                                   ,[FBillNo]
                                   ,[amount]
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"INSERT INTO [dbo].[POOrderNODone]
                               ([FBillNo]
                               ,[deposit_id]
                               ,[insert_time]
                               ,[customer_code]
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"SELECT * FROM [dbo].[payment_deposit_head]";
            using (DbConnection cn = db.CreateConnection())
            {
                try
                {
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"SELECT * FROM [dbo].[payment_deposit_head] WHERE deposit_id=@deposit_id";
            using (DbConnection cn = db.CreateConnection())
            {
                try
                {
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"SELECT * FROM [dbo].[payment_deposit_list] WHERE deposit_id=@deposit_id";
            using (DbConnection cn = db.CreateConnection())
            {
                try
                {
        ...
        public DataSet getDepositHeads(string deposit_id)
        {
            Database db = Dao.GetDatabase();
            DataSet ds;
            string sql = @"SELECT * FROM [dbo].[payment_deposit_head] WHERE deposit_id LIKE @deposit_id;";
            using (DbConnection cn = db.CreateConnection())
            {
                DbCommand cmd = db.GetSqlStringCommand(sql);
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"delete FROM [dbo].[POOrderNODone] WHERE deposit_id=@deposit_id";
            using (DbConnection cn = db.CreateConnection())
            {
                try
                {
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"delete FROM [dbo].[payment_deposit_head] WHERE deposit_id=@deposit_id;
                           delete FROM [dbo].[payment_deposit_list] WHERE deposit_id=@deposit_id ";
            using (DbConnection cn = db.CreateConnection())
            {
                try
                {
        ...
        {
            Database db = Dao.GetDatabase();
            string sql = @"UPDATE [dbo].[payment_deposit_head]
